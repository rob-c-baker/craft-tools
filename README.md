...
```
cd existing_repo
git remote add origin https://gitlab.alanrogers.com/web-dev/craft-tools.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.alanrogers.com/web-dev/craft-tools/-/settings/integrations)
